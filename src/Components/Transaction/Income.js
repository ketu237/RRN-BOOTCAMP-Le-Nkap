...
function IncomePage() {
    ...
    return (
        <div className="bg-white-500">
            <Navbar />
            {shouldDisplayMessage && <p className='font-semibold text-sm text-red-500'></p>}
            <div className="w-full min-h-screen bg-white-200 p-5 flex items-center">
                <div className="bg-white w-full shadow-lg rounded-xl p-8 m-4 md:max-w-sm md:mx-auto flex flex-col">
                    <div className="mt-1 flex mb-1 justify-between">
                        <div className="justify-items-start">
                            <Link to="/transactions" className="  text-left rounded-xl px-4 py-1 text-sm text-red-600 font-semibold border border-red-200 hover:text-white hover:bg-red-600 hover:border-transparent hover:scale-105 duration-300 focus:outline-none focus:ring-2 focus:ring-red-600 focus:ring-offset-2">
                                <FontAwesomeIcon icon={faArrowLeft} className="mr-2" /> Transactions</Link>
                        </div>
                        <div className="justify-items-end ">
                            <Link to="/expenses" className=" text-right rounded-xl px-4 py-1 text-sm text-red-600 font-semibold border border-red-200 hover:text-white hover:bg-red-600 hover:border-transparent hover:scale-105 duration-300 focus:outline-none focus:ring-2 focus:ring-red-600 focus:ring-offset-2">
                    ...
                    <form className="bg-white shadow-md font-bold rounded-xl px-8 pt-6 pb-8 mt-3 inline-block"
                        ...
                        <div className="flex flex-col md:flex-row mb-4 mt-4">
                            <label className="mb-2 capitalize font-semibold text-lg text-gray-darkest" htmlFor="category">
                                Income Category:
                            </label>
                            <select
                                name="categoryId"
                                className='p-2 rounded-xl w-full border border-red-300 mt-2'
                        ...
                        <div className="mb-4 mt-4 flex ">
                            {!selectedTransaction && (
                                <button className='mx-auto rounded-xl w-3/4 px-4 py-1 text-sm text-red-600 font-semibold border border-red-200 hover:text-white hover:bg-red-600 hover:border-transparent hover:scale-105 duration-300 focus:outline-none focus:ring-2 focus:ring-red-600 focus:ring-offset-2 mb-3'
                                    type="submit"
                                    onClick={addIncome}>
                                    Add Income
                            ...
                            {selectedTransaction && (
                                <div className="flex justify-center mx-auto">
                                    <button style={{ marginRight: '60px' }} className='rounded-xl px-4 py-1 text-sm text-red-600 font-semibold border border-red-200 hover:text-white hover:bg-red-600 hover:border-transparent hover:scale-105 duration-300 focus:outline-none focus:ring-2 focus:ring-red-600 focus:ring-offset-2 mb-3'
                                        type="submit"
                                        onClick={updateIncome}>
                                        Update Income
                                        {submitting && <FontAwesomeIcon icon={faSpinner} spin size="lg" className="mr-2 ml-2" />}
                                    </button>
                                    <button style={{ marginLeft: '60px' }} className='rounded-xl px-4 py-1 text-sm text-red-600 font-semibold border border-red-200 hover:text-white hover:bg-red-600 hover:border-transparent hover:scale-105 duration-300 focus:outline-none focus:ring-2 focus:ring-red-600 focus:ring-offset-2 mb-3'
                                        type="button"
                    ...
                    {successMessage && (
                        <div style={{ color: selectedTransaction ? 'orange' : 'red' }} className='font-bold text-center'>{successMessage}</div>
                    )}
                    <div className="my-8">
