...
function TransactionForm() {
  ...
  return (
    <div className="bg-white-200">
      ...
      <div className="w-full min-h-screen bg-white-900 p-5 flex items-center">
        ...
        <div className="mt-1 flex mb-1 justify-between">
                        <div className="justify-items-start">
                            <Link to="/income" className="  text-left rounded-xl px-4 py-1 text-sm text-red-600 font-semibold border border-purple-200 hover:text-white hover:bg-red-600 hover:border-transparent hover:scale-105 duration-300 focus:outline-none focus:ring-2 focus:ring-red-600 focus:ring-offset-2">
                                <FontAwesomeIcon icon={faArrowLeft} className="mr-2" /> Income</Link>
                        </div>
                        <div className="justify-items-end ">
                            <Link to="/expenses" className=" text-right rounded-xl px-4 py-1 text-sm text-red-600 font-semibold border border-purple-200 hover:text-white hover:bg-red-600 hover:border-transparent hover:scale-105 duration-300 focus:outline-none focus:ring-2 focus:ring-red-600 focus:ring-offset-2">
          ...
          <form className="bg-white  shadow-md font-bold rounded-xl px-8 pt-6 pb-8 mt-3 inline-block"
            ...
            <div className="flex flex-col mb-4 mt-4">
              ...
              <input
                type="text"
                name="name"
                className='p-2 rounded-xl w-9 border border-red-500'
                value={formData.name}
            ...
            <div className="flex flex-col mb-4 mt-4">
              ...
              <select
                name="type"
                className='"p-2 rounded-xl w-14 sm:w-20 border border-red-500'
                value={formData.type}
                onChange={handleChange}
                required
              >
  ...
  <option value="income">Income</option>
          ...
          <div className="flex flex-col mb-4 mt-4">
            ...
            <select className='p-2 rounded-xl w-full border border-red-00'
