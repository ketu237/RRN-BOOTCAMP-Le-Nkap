...
function ExpensePage() {
    ...
    return (
        <div className="bg-white-200">
            ...
            <div className="w-full min-h-screen bg-white-500 p-5 flex items-center">
                <div className="bg-white w-full shadow-lg rounded-xl p-8 m-4 md:max-w-sm md:mx-auto flex flex-col">
                    <div className="mt-1 flex mb-1 justify-between">
                        ...
                        <div className="justify-items-end ">
                            <Link to="/income" className=" text-right rounded-xl px-4 py-1 text-sm text-red-600 font-semibold border border-red-200 hover:text-white hover:bg-red-600 hover:border-transparent hover:scale-105 duration-300 focus:outline-none focus:ring-2 focus:ring-red-600 focus:ring-offset-2">
                    ...
                    <form className="bg-white shadow-md font-bold rounded-xl px-8 pt-6 pb-8 mt-3 inline-block"
                        ...
                        <div className="flex flex-col mb-4 mt-4">
                            ...
                            <input
                                type="text"
                                name="name"
                                className='p-2 rounded-xl w-full border border-red-700'
                                value={formData.name}
                        ...
                        <div className="flex flex-col mb-4 mt-4">
                            ...
                            <input
                                type="number"
                                name="amount"
                                className='p-2 rounded-xl w-full border border-red-500'
                        ...
                        <div className="flex flex-col mb-4 mt-4">
                            ...
                            <select
                                name="categoryId"
                                className='p-2 rounded-xl w-full border border-red-500 mt-2'
